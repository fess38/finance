...
import { Category, Currency, Summary, Transaction } from '../core/model/model';
...
export class TransactionUtils {
  ...
  static categorySummaries(transactions: Transaction[], income: number, expense: number): Map<number, Summary> {
